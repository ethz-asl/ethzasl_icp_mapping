...
MapperParameters::MapperParameters()
    : use_const_motion_model(getParam<bool>("useConstMotionModel", false)),
      ...
      vtk_final_map_name(
          getParam<std::string>("vtkFinalMapName", "finalMap.vtk")),
      ...
      map_trigger(false), use_logger(getParam<bool>("useROSLogger", false)),
      ...
      process_loaded_map(getParam<bool>("process_loaded_map", false))
{
